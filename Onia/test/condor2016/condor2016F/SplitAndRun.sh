...
myeospath1="/store/user/cdozen/FourMuon_Analysis/MuOnia/2016_v2/MuOnia/BPHSkim--Run2016F-07Aug17-v1/190620_113154/0000"
myeospath2="/store/user/cdozen/FourMuon_Analysis/MiniBias/2016_v2/ZeroBias/BPHSkim--Run2016F-07Aug17-v1/190620_113627/0000"
...
do 
	...
	cat runMixingRootupler.py | sed "s:INPUTPATH1:${myeospath1}:" | sed "s-INPUTFILE-${inputFiles2}-" | sed "s/NUMBER/${jobNb}/g" | sed "s:MIXINPUTPATH:${myeospath2}:" | sed "s-MIXFILEINPUT-${inputFiles1}-" > ${jobCScript} ;
